...
public class Principal extends javax.swing.JFrame {
    ...
    private void tbl_func_funcsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_func_funcsMouseClicked
        ...
        if(index>=0 && index<ListaFunc.size()){
            ...
            cb_func_deps.setSelectedItem(F.getNome()); //Não sei se esta certo
            modoFunc = "Selecao";
            ManipulaInterfaceFunc();
        }
    ...
    private void btn_func_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_func_salvarActionPerformed
        ...
        if(index==0){
            ...
            int index2 = tbl_func_funcs.getSelectedRow();
            ListaFunc.get(index2).setMatricula(Integer.parseInt(c_func_mat.getText()));
            ListaFunc.get(index2).setNome(c_func_nome.getText());
            ListaFunc.get(index2).setDep(ListaDep.get(index2));
        }
        ...
        ManipulaInterfaceFunc();
         c_func_mat.setText("");
        c_func_nome.setText("");
        cb_func_deps.setSelectedItem(""); //Não sei se esta certo
        c_dep_nome.setText("");
